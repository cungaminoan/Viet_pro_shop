					...
					<div class="panel-body">
						<div class="bootstrap-table">
							<div class="table-responsive">
								...
								<a href="processed.blade.php" class="btn btn-success">Đơn đã xử lý</a>
								<table class="table table-bordered" style="margin-top:20px;">
									...
									<tbody>
										<tr>
											...
											<td>Thường tín</td>
											<td>
												<a href="orders/detailorder.blade.php" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i>Xử lý</a>
